                ...
                @if($attraction->is_active || (auth()->check() && Auth::user()->isAdmin()))
                    ...
                    <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow 
                        ...
                        <div class="p-4 space-y-3">
                            ...
                            <div class="flex items-start justify-between gap-2">
                                ...
                                @if($attraction->rating)
                                    <div class="flex-shrink-0">
                                        <div class="bg-white px-3 py-1.5 rounded-full shadow-sm flex items-center gap-1 border border-gray-200">
                            ...
                            {{-- ЗМІНА: Бейдж "Ukryta" тільки для адміна --}}
