            ...
            <div class="bg-white shadow-lg rounded-xl overflow-hidden hover:shadow-2xl transition">
                ...
                <div class="p-4 space-y-2">
                    ...
                    <div class="text-sm font-medium text-gray-700">
                        Status:
                        @if ($n->status === 'pending')
                            <span class="px-2 py-1 bg-yellow-200 text-yellow-700 rounded">Oczekuje na
                                zatwierdzenie</span>
                ...
                <div class="p-4 border-t flex items-center justify-between space-x-2">
                    ...
                    <div class="flex gap-2 mt-4">
                        <button wire:click="deleteNocleg({{ $n->id }})"
                            ...
                            title="{{ __('noclegi.actions.delete') }}">
                        ...
                        @if ($n->status === 'rejected')
                            <div class="flex-1 text-center">
                                <span class="text-red-600 block mb-2">
                                    Odrzucony: {{ $n->reject_reason }}
                                </span>
                                <button wire:click="resubmit({{ $n->id }})"
                                    class="text-blue-600 hover:text-blue-900 text-sm underline">
                                    Prześlij ponownie do moderacji
                                </button>
                            </div>
                        @endif
